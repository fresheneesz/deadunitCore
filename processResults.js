module.exports = function returnResults(unitTestObject) {
    //if(!this.testResults.tester.mainTester.resultsAccessed) { // if its the first time results were grabbed
        ...
        unitTestObject.mainTester.resultsAccessed = true // resultsAccessed allows the unit test to do special alerting if asynchronous tests aren't completed before the test is completed
        return results
    //}
    ...
    //return unitTestObject.testResults
}
